          ...
          <div class="row justify-content-center">
            ...
            <form action="{{ url('pengaturan')}}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="time" name="jammulai" style="width: 700px; height: 50px;">
              </div>
              <div class="form-group">
                <label for="jamtelat">JAM TELAT</label>
                <input type="time"  name="jamselesai" style="width: 700px; height: 50px;">
              </div>
              <div class="form-group">
                <label for="jamtelat">DURASI WAKTU</label>
                <input type="number"  name="durasi_waktu" style="width: 700px; height: 50px;">
              </div>
