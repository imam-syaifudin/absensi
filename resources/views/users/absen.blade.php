...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <form action="{{ url('/tambahlaporan') }}" method="POST">
                  @csrf
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="oi" value="{{ $arr['value']}}" name="keterangan" aria-describedby="" readonly>
                    </div>
                    @if ( $arr['value'] != "anda sudah absen")
